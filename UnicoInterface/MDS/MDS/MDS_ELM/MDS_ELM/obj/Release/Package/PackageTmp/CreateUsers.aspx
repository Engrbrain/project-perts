<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CreateUsers.aspx.vb" Inherits="MDS_ELM.CreateUsers" %>

<%@ Register Src="~/DesktopModule/RegisterUsers.ascx" TagPrefix="uc1" TagName="RegisterUsers" %>
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#"><b>/Create Users</b></a></li>
				...
				<div id="dashboard">
					...
					<div class="row-fluid">
                        <uc1:RegisterUsers runat="server" ID="RegisterUsers" />
                    </div>
