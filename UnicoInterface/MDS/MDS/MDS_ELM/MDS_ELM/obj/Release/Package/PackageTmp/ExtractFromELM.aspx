<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ExtractFromELM.aspx.vb" Inherits="MDS_ELM.ExtractFromELM" %>

<%@ Register Src="~/DesktopModule/Extract_From_ELM.ascx" TagPrefix="uc1" TagName="Extract_From_ELM" %>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							EXTRACT FROM ELM <small>Extract Billing Document and Load</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="#"><b>/Extract from ELM</b></a></li>
				...
				<div id="dashboard">
					...
					<div class="row-fluid">
                        <uc1:Extract_From_ELM runat="server" ID="Extract_From_ELM" /> </div>
