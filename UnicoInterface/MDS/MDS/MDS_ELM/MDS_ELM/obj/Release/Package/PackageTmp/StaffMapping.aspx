<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StaffMapping.aspx.vb" Inherits="MDS_ELM.StaffMapping" %>

<%@ Register Src="~/DesktopModule/AddNewSalesPerson.ascx" TagPrefix="uc1" TagName="AddNewSalesPerson" %>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							STAFF MAPPING <small>Map Salesmen from ELM Deports to SAP Personnel Number</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="#"><b>/Staff Mapping</b></a></li>
				...
				<div id="dashboard">
					...
					<div class="row-fluid">
                        <uc1:AddNewSalesPerson runat="server" ID="AddNewSalesPerson" />    </div>
