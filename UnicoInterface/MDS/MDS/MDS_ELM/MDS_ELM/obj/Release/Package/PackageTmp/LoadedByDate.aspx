<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LoadedByDate.aspx.vb" Inherits="MDS_ELM.LoadedByDate" %>
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown user">
						...
						<ul class="dropdown-menu">
							<li><a href="extra_profile.html"><i class="icon-user"></i>  <asp:LinkButton ID="lnkMyProfile" runat="server">My Profile</asp:LinkButton></a></li>
	...
	<div class="page-container row-fluid">
		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul>
				...
				<li class="">
					<a href="LoadedByDate.aspx">
					<i class="icon-bar-chart"></i> 
					<span class="title">Loaded By Date</span>
					</a>
				</li>
				<li class="">
					<a href="FailedToLoad.aspx">
					<i class="icon-calendar"></i> 
					<span class="title">Failed Idoc</span>
					</a>
				</li>
				<li class="">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							Loaded Sales Orders <small>Search Loaded Sales Orders By Date</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="#"><b>/Loaded Sales Orders</b></a></li>
				...
				<div id="dashboard">
					...
					<div class="row-fluid">
                     <img src="assets/img/work-in-progress.jpg" /></div>
