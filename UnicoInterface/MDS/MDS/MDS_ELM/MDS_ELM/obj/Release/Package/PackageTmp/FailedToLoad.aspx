<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FailedToLoad.aspx.vb" Inherits="MDS_ELM.FailedToLoad" %>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							Failed to Load <small>List of Items that failed SAP IDOC Check</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
