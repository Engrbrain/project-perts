<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="index.aspx.vb" Inherits="MDS_ELM.index" %>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							MDS ELM TO SAP			
							<small>Data Migration ETL Interface</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
				...
				<div id="dashboard">
					...
					<div class="row-fluid">
						<div class="span3 responsive" data-tablet="span6" data-desktop="span3">
							<div class="dashboard-stat blue">
								...
								<div class="details">
									<div class="number">
                                        <asp:Label ID="lblNumberOfClient" runat="server" Text="Label"></asp:Label>
									</div>
									<div class="desc">									
										Number of Clients
									</div>
						...
						<div class="span3 responsive" data-tablet="span6" data-desktop="span3">
							<div class="dashboard-stat green">
								...
								<div class="details">
									<div class="number"><asp:Label ID="lblNumberOfBillItems" runat="server" Text="Label"></asp:Label></div>
									<div class="desc"> Bill Items</div>
								</div>
								<a class="more" href="#">
								View more <i class="m-icon-swapright m-icon-white"></i>
								</a>						
						...
						<div class="span3 responsive" data-tablet="span6  fix-offset" data-desktop="span3">
							<div class="dashboard-stat purple">
								...
								<div class="details">
									<div class="number"><asp:Label ID="lblNumberofDeports" runat="server" Text="Label"></asp:Label></div>
									<div class="desc">Deports</div>
								</div>
								<a class="more" href="#">
								View more <i class="m-icon-swapright m-icon-white"></i>
								</a>						
						...
						<div class="span3 responsive" data-tablet="span6" data-desktop="span3">
							<div class="dashboard-stat yellow">
								...
								<div class="details">
									<div class="number"><asp:Label ID="lblLoadedSalesOrders" runat="server" Text="Label"></asp:Label></div>
									<div class="desc"> Sales orders</div>
								</div>
								<a class="more" href="#">
								View more <i class="m-icon-swapright m-icon-white"></i>
								</a>						
					...
					<div class="row-fluid">
                        <img src="assets/img/MDSBanner.jpg" /></div>
