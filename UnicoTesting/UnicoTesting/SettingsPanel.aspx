<%@ Register Src="~/SettingsPanel.ascx" TagPrefix="uc1" TagName="SettingsPanel" %>
...
<a href="TechnicalReport.aspx" >
  ...
  <h1><i class="icon-bar-chart"></i>Settings Panel</h1>
</div>
<ol class="breadcrumb">
  <li><a href="#">Settings Panel</a></li>
          ...
          <div class="main-content">
             ...
             <form id="form1" runat ="server" >
                 ...
                 <uc1:SettingsPanel runat="server" ID="SettingsPanel" />
              </form>
