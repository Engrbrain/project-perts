<%@ Register Src="~/LoadedData.ascx" TagPrefix="uc1" TagName="LoadedData" %>
...
<a href="TechnicalReport.aspx" >
  ...
  <h1><i class="icon-bar-chart"></i>Loaded Data By Date</h1>
</div>
<ol class="breadcrumb">
  <li><a href="#">Loaded Data By Date</a></li>
          ...
          <div class="main-content">
             ...
             <form id="form1" runat ="server" >
                 ...
                 <uc1:LoadedData runat="server" ID="LoadedData" />
              </form>
