<%@ Register Src="~/IdocReport.ascx" TagPrefix="uc1" TagName="IdocReport" %>
...
<a href="TechnicalReport.aspx" >
  ...
  <h1><i class="icon-bar-chart"></i>Technical Report (IDOC)</h1>
</div>
<ol class="breadcrumb">
  <li><a href="#">Technical Report</a></li>
          ...
          <div class="main-content">
             ...
             <form id="form1" runat ="server" >
                 ...
                 <uc1:IdocReport runat="server" ID="IdocReport" />
              </form>
