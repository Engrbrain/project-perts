<%@ Register Src="~/AddGL_Account.ascx" TagPrefix="uc1" TagName="AddGL_Account" %>
...
<a href="TechnicalReport.aspx" >
  ...
  <h1><i class="icon-bar-chart"></i> Add GL Account</h1>
</div>
<ol class="breadcrumb">
  <li><a href="#">Add GL Account</a></li>
          ...
          <div class="main-content">
             ...
             <form id="form1" runat ="server" >
                 ...
                 <uc1:AddGL_Account runat="server" ID="AddGL_Account" />
              </form>
