...
<script runat="server">
Public Function ServerSideFunction() As String
	If UserController.GetCurrentUserInfo.UserID > 0 Then
		MyLoginDiv.Visible= False
		Me.MyRegDiv.Visible = False
		MyLogOutDiv.Visible = True
	Else
		MyLogOutDiv.Visible = False
		Me.MyRegDiv.Visible = True
		MyLoginDiv.Visible = True
	End If
	Return String.Empty
End Function
</script>
...
<div id="DNN6" class="Home">
    ...
    <div id="LogoRow">
                ...
                <div class="LogoRowRight">
                    <div id="Login"><dnn:LOGIN ID="dnnLogin" CssClass="LoginLink" runat="server" Visible="false" />|<dnn:USER ID="dnnUser" runat="server" />
					<dnn:LANGUAGE runat="server" id="dnnLANGUAGE"  showMenu="False" showLinks="True" />
                   <% =ServerSideFunction() %>
                    <%--<dnn:SEARCH ID="dnnSearch" runat="server" UseDropDownList="true" EnableTheming="true" Submit="Search" />--%>
                    <div class="register" id ="MyRegDiv" runat ="server"> <h6> <a href="http://192.168.129.50/billsandme/Login.aspx">register now</a></h6></div>
                    <div class="login" id ="MyLoginDiv"  runat ="server"> <h6> <a href="http://192.168.129.50/billsandme/Login.aspx">register now</a></h6></div>
                    <div class="logout" id ="MyLogOutDiv"  runat ="server"> <h6> <a href="http://192.168.129.50/billsandme/LogOff.aspx">register now</a></h6></div>
					</div>
