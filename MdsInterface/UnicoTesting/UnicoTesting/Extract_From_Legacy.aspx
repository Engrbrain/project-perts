<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Extract_From_Legacy.aspx.vb" Inherits="UnicoTesting.Extract_From_Legacy1" %>

<%@ Register Src="~/Extract_From_Legacy.ascx" TagPrefix="uc1" TagName="Extract_From_Legacy" %>
...
<a href="TechnicalReport.aspx" >
  ...
  <h1><i class="icon-bar-chart"></i> Home</h1>
</div>
<ol class="breadcrumb">
  <li><a href="#">Home</a></li>
          ...
          <div class="main-content">
             ...
             <form id="form1" runat ="server" >
                 <div>
              <uc1:Extract_From_Legacy runat="server" ID="Extract_From_Legacy" />
