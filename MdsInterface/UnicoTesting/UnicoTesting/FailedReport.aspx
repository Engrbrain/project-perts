<%@ Register Src="~/UnBalancedData.ascx" TagPrefix="uc1" TagName="UnBalancedData" %>
...
<a href="TechnicalReport.aspx" >
  ...
  <h1><i class="icon-bar-chart"></i> Un - Balanced Transactions</h1>
</div>
<ol class="breadcrumb">
  <li><a href="#">Failed Data By Date</a></li>

</ol>
          <div class="main-content">
           
             <form id="form1" runat ="server" >
              <uc1:UnBalancedData runat="server" ID="UnBalancedData" />
