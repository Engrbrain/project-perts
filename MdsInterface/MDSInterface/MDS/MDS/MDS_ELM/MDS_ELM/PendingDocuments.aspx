<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PendingDocuments.aspx.vb" Inherits="MDS_ELM.PendingDocuments" %>

<%@ Register Src="~/DesktopModule/ViewCurrentLoad.ascx" TagPrefix="uc1" TagName="ViewCurrentLoad" %>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#"><b>/Pending DOcuments</b></a></li>
				...
				<div id="dashboard">
					...
					<div class="row-fluid">
                        ...
                        <uc1:ViewCurrentLoad runat="server" ID="ViewCurrentLoad" />
                    </div>
