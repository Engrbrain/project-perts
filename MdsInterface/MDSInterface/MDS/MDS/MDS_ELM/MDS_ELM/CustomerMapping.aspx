<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CustomerMapping.aspx.vb" Inherits="MDS_ELM.CustomerMapping" %>

<%@ Register Src="~/DesktopModule/AddNewCustomers.ascx" TagPrefix="uc1" TagName="AddNewCustomers" %>
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown user">
						...
						<ul class="dropdown-menu">
							<li><a href="extra_profileaspx."><i class="icon-user"></i>  <asp:LinkButton ID="lnkMyProfile" runat="server">My Profile</asp:LinkButton></a></li>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							CUSTOMER MAPPING <small>Mapping ELM Customers to SAP Customer Numbers</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="#"><b>/Customer Mapping</b></a></li>
				...
				<div id="dashboard">
					...
					<div class="row-fluid">
                        <uc1:AddNewCustomers runat="server" ID="AddNewCustomers" /> </div>
