<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="AddNewSalesPerson.ascx.vb" Inherits="MDS_ELM.AddNewSalesPerson" %>
                    ...
                    <td style="width: 100%">
                        <asp:DataGrid ID="dgSalesPerson" runat="server" AllowPaging="False" AlternatingItemStyle-CssClass="altRow" AutoGenerateColumns="False" CssClass="gridBorder" DataKeyField="ID" GridLines="Horizontal" ShowFooter="False" Width="100%">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Personnel Number">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPERSONNELID" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "PERSONNELID")%>'>
                                                    </asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="cpTableHeader" Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                ...
                                <td colspan="2">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <table class="auto-style1">
                                                <tr>
                                                    <td width="50%">SAP Personnel ID:</td>
                                                    <td width="50%">SAP Full Name:</td>
                                                </tr>
                                                <tr>
                                                    <td width="50%">
                                                        <asp:DropDownList ID="ddlPersonnelInformation" runat="server" AutoPostBack="True" Width="100%">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td width="50%">
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            ...
                                            <td align="right" style="width: 50%">
                                                <asp:Button ID="btnSearch" runat="server" CssClass="button" Text="Add Sales Person" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
