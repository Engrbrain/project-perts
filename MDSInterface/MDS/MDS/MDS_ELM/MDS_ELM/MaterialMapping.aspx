<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MaterialMapping.aspx.vb" Inherits="MDS_ELM.MaterialMapping" %>


<%@ Register Src="~/DesktopModule/AddNewMaterial.ascx" TagPrefix="uc1" TagName="AddNewMaterial" %>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							MATERIAL MAPPING <small>Map Bill Items in ELM to Materials in SAP</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="#"><b>/Material Mapping</b></a></li>
				...
				<div id="dashboard">
					...
					<div class="row-fluid">
                        <uc1:AddNewMaterial runat="server" ID="AddNewMaterial" />  </div>
